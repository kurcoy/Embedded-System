...
extern StackType_t RTC3232_taskStack[DS3232_STACK_SIZE] CCM_RAM;  // Put task stack in CCM
extern StaticTask_t RTC3232_taskBuffer CCM_RAM;  // Put TCB in CCM
typedef struct
{
	uint8_t addr;
	uint8_t value;
...
int RTCDS3232_Time_Init(Time_Typedef *TimeVAL);
uint8_t  RTC3232_ReadTime(Time_Typedef  *TimeVAL);
extern uint8_t RTCDS3232_Check(void);
